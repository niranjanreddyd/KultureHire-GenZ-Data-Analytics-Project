...
* Study gender-wise differences in work preferences
* Understand work frustrations and motivation factors
* Analyze expectations for work-life balance
* Evaluate interest in education abroad & sponsorship
* Build dashboards for easy insight communication
...
├── 📊 Manager Aspirations Dashboard.xlsx
├── 📊 Mission Aspirations Dashboard.xlsx
├── 📊 Learning Aspirations Dashboard.xlsx
│
├── 📘 5W1H Analysis.docx
├── 📘 GenZ.txt
├── 📘 1.txt
│
├── 📄 Que Your Career Aspirations.xlsx
├── 📄 SQL KultureHire Notepad.txt
├── 📄 SQL Queries.docx
│
└── README.md  
...
* CASE statements
* Calculating distributions & percentages
...
2. % interested in education abroad
3. Top career influences
4. Gender-wise career aspiration comparison
5. Willingness to stay ≥ 3 years
6. Preference for socially impactful companies
7. Gender-wise variation in social impact interest
8. Expected minimum salary (0–3 years)
9. Expected minimum monthly in-hand salary
10. Remote working preference
11. Preferred daily work hours
12. Common work frustrations
13. Work-life balance need by gender
14. Willingness to work under abusive manager
15. Salary expectations after 5 years
16. Remote working preference by gender
17. Top frustrations by gender
18. Factors that boost work happiness
19. Need for sponsorship for education abroad
